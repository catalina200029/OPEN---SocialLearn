...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 31, 2018 at 08:25 AM
...
DROP TABLE IF EXISTS `lectievotes`;
CREATE TABLE IF NOT EXISTS `lectievotes` (
  `lectieID` int(11) NOT NULL,
  `userID` int(11) NOT NULL,
  `vot` int(11) NOT NULL,
  PRIMARY KEY (`lectieID`,`userID`)
...
(1, 'Teo', 'Virghi', 'KemyKo', 'teo.virghi@yahoo.ro', 'Teodor00', 0, 1),
(2, 'Lincan', 'Iulia', 'iulialincan2', 'tedali@yahoo.com', '3123123', 1, 1),
(3, 'Olteanu', 'Catalina', 'catalina200029', 'catalina200029@yahoo.com', 'cata3151', 0, 1),
(4, 'Marius', 'Marinel', 'Marcel', 'marinel@yahoo.com', 'Krystelnyta', 0, 1),
(5, 'Stan', 'Razvan', 'razvan', 'stanel@yahoo.ro', 'parola', 0, 2),
(6, 'Eduard', 'Stoicul', 'Eddyy', 'stoicy@gmail.ro', 'ParolaPass', 0, 2),
(7, 'Andrei', 'Parvulescu', 'Magician', 'mag@gmail.com', 'kastelus', 0, 1),
(8, 'Timmy', 'Barbos', 'KimTim', 'barby@yahoo.ro', 'biricel', 0, 2),
(9, 'Ionela', 'Biscuit', 'Magurel', 'bicky123@index.ro', 'niGror21', 0, 2),
(10, 'Ana', 'Mirabela', 'Grijan', 'emailus.ro', 'passcode123', 0, 1),
(11, 'Radu', 'Canu', 'Radulet', 'kanuradu@yahoo.ro', '123123', 1, 2),
(12, 'Marian', 'Andrei', 'Marianul', 'faggot@yahoo.ro', '123123', 1, 1),
(13, 'Androne', 'Vlad', 'grabogne', 'garr@yahoo.ro', 'barBut', 0, 1),
(14, 'Raut', 'Ana-Maria', 'Sindy', 'sindd@gmail.com', 'Casa2009Teo', 1, 2);
COMMIT;
